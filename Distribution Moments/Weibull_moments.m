...
function [mu, second_cen_moment, third_cen_moment, ...
    fourth_cen_moment, Ex] =  Weibull_moments(alpha, beta)
% INPUTS
%
...
% True statistics
Ex1 = alpha*gamma(1/beta + 1);     % E [ x ]
Ex2 = alpha^2*gamma(2/beta + 1);     % E [ x^2 ]
Ex3 = alpha^3*gamma(3/beta + 1);     % E [ x^3 ]
Ex4 = alpha^4*gamma(4/beta + 1);     % E [ x^4 ]
